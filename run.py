...
def validate_data(values):
    ...
    Raise ValueError if strings couldn't be converted into interger,
...
def get_last_5_entries_sales():
    """
    Collects collums of data from sales worksheet, collecting the
    last 5 enteries for each sandwhich and returns the data as
    a list of lists.
    """
